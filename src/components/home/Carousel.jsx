...
export default function Carousel(props) {
    ...
    return (
        <div className="relative flex h-full w-full py-10 bg-gradient-to-br from-[#000778] from-[20%] via-slate-500 via-30% to-[#FF9201] to-40% md:to-40%">
            <div className="mx-auto sm:px-10 relative px-5 w-full flex flex-row justify-center overflow-hidden md:h-auto rounded-[4rem]">
                <Swiper
                    slidesPerView={1}
                    centeredSlides={true}
                    spaceBetween={30}
                ...
                >
                    {
                        ...
                        props.slides.map(slide => (
                            ...
                            <img 
                                id=""
                                src={slide}
                                className="aspect-video sm:aspect-auto h-max mx-auto w-full inline-block object-center sm:object-contain rounded-[4rem]"
                            />
                            </SwiperSlide>
                        ))
                    }
