...
import eventsData from "../../api/eventsApi";
...
export default function Events() {
    ...
    useEffect(() => {
        setUpcoming_Event(eventsData["upcoming-events"].data);
        setPast_Event(eventsData["past-events"].data);
    }, [])
                    ...
                    {   
                        upcoming_event && upcoming_event.map(currEvent => (
                            <EventCard 
                                ...
                                criteria="All"
                                image={currEvent.attributes.name.toLowerCase().includes('cp hackathon') ? CPHackathon : currEvent.attributes.image}
